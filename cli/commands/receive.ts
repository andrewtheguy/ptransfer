 ...
 * folder `--out` names, or the current directory, under the name the sender
...
the current directory, or the folder --out names, under the name the sender
gave it; several files or a folder arrive as one ZIP. The one-time password
is read from standard input: typed at a prompt, or piped in.

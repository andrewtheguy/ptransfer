...
import { PTRANSFER_CLI_DOCS_URL } from '@/lib/constants';
    ...
    <div className="space-y-3">
      ...
      <Collapsible className="space-y-2">
        ...
        <CollapsibleContent className="space-y-2 text-xs text-muted-foreground">
          ...
          <p>
            The sender does not have to be a browser. A PIN, a{' '}
            <code>.onion</code> address, or a sender code minted by{' '}
            <a
            ...
            , this app on the command line, is pasted here exactly the same way
            — the terminal carries Code Exchange as text, since it has no camera
            to scan a QR grid with.
          </p>
        </CollapsibleContent>
      </Collapsible>
    </div>

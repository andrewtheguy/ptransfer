...
build (WSL counts as Linux). For a command line on Windows, or for files
larger than 2 GiB, use [beam-rs](https://github.com/andrewtheguy/beam-rs)
instead. `cli/` is a Bun application that imports
